...
--디폴트
alter table tester modify cdate default systimestamp; --운영체제 일시를 기본값으로
alter table tester modify udate default systimestamp; --운영체제 일시를 기본값으로
